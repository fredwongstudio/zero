...
export function Experience(props: CallViewProps) {
  return <div className="site-shell">
    <header className="site-header"><a href="/" aria-label="Fred Wong Studio — ZERO home">FRED WONG <span>STUDIO</span></a><span className="project-label">AN EXPERIMENT IN HOSPITALITY</span></header>
    <main id="main"><div className="intro"><div className="wordmark-row"><h1>ZERO<span className="wordmark-period">.</span></h1><span className="edition">VOICE EXPERIMENT<br/>NO. 01 / 2026</span></div><div className="intro-bottom"><p className="tagline">Dial 0. Just ask.</p><p className="byline">An AI hotel operator prototype<br className="desktop-break"/> by Fred Wong Studio.</p></div></div>
      ...
      <div className="about-project"><p className="eyebrow">ABOUT THIS EXPERIMENT</p><p>{description}</p></div>
    </main>
